...
def add_data_options(parser):
    ...
    parser.add_argument('-subword', type=str2bool)
    parser.add_argument('-is_save', type=str2bool)
    parser.add_argument('-pointer_gen', type=str2bool)
    parser.add_argument('-is_coverage', type=str2bool)
    parser.add_argument('-cov_loss_wt', type=float)  # 1.0
    parser.add_argument('-share_embedding', type=str2bool)
    parser.add_argument('-lm_model_file', type=str)
    ...
    parser.add_argument('-beam_size', type=int, default=12,
                        help='Beam size')
    parser.add_argument('-max_sent_length', type=int, default=100,  # 文摘的
                        help='Maximum sentence length.')
    parser.add_argument('-max_sent_length_source', type=int,
                        help='Maximum sentence length.')
