#!/bin/bash
set -x
SAVEPATH=../../../data/toutiao_word/models/seass
DATAHOME=../../../data/toutiao_word
...
python train.py \
       ...
       -dev_input_src ${DATAHOME}/dev/subword/valid.article.txt -dev_ref ../../../data/toutiao_char/dev/valid.title.txt \
